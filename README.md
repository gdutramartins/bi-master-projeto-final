...
A proposta do trabalho é a utilizar os textos obtidos pelas ferramentas de clipping e suas respectivas análises de sentimento para treinar uma rede neural capaz de avaliar o sentimento de textos postados sobre o BNDES.
...
BNDES (National Bank for Economic and Social Development) has strategic indicators to measure the sentiment of articles and posts published on social networks (Facebook, Twitter, Instagram, etc.) or in the press. Currently there is a company hired to perform the clipping and measurement of sentiment (positive, neutral and negative).
The proposal of the work is to use the texts obtained by the clipping tools and their respective sentiment analysis to train a neural network capable of evaluating the sentiment of texts posted on the BNDES.
